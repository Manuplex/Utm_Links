...
<div class="w-full h-108 absolute pointer-events-none blur-3xl z-10 border border-white/50 mt-12  bg-white/25 rounded-xl mx-auto  ">
    ...
    <form class="row-span-4 grid grid-row-4 mt-8 gap-y-6" action="" method="POST">
        @csrf
        ...
        <div class="row-span-2 flex flex-col justify-start">
            ...
            <span class="text-center text-white">Not account?? <a href="#1.html" class="text-[#ff0dae] ml-2 hover:text-[#00000075] underline underline-offset-2">Sign Up First</a></span>
        </div>
    </form>
</div>
